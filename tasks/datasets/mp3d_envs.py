...
msgpack_numpy.patch()
import sys
sys.path.append("/data1/nieyunshuang/nys_new/zhaolx/Matterport3DSimulator/build")
sys.path.append("/data1/nieyunshuang/nys_new/zhaolx/Matterport3DSimulator") # works for No module named MatterSim
