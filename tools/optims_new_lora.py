...
def dist_models(args, model, logger):
    ...
    ## newly added: load navillm for post training
    ...
    ## newly added: load lora weight to resume training
    if args.resume_from_checkpoint is not None:
    ...
    # logger.info(f"model trainable parameters: {trainable_param_names}")
